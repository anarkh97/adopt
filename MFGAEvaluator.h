...
#ifndef _MFGA_EVALUATOR_H_
#define _MFGA_EVALUATOR_H_
...
public:
  ...
  MFGAEvaluator(JEGA::Algorithms::GeneticAlgorithm &algorithm_,
                Dakota::Model &sim_model_, Dakota::Model &error_model_,
                AdaptiveDecisionMaker &decision_maker_);

  //! Copy constructor
  MFGAEvaluator(const MFGAEvaluator &copy);
...
protected:
  ...
  void RecordErrorInDecisionMaker(const int id, const Dakota::RealVector &from,
                                  const Dakota::RealVector &cont_vars);
