...
void AdaptiveDecisionMaker::ReadOptionsFile(const String filename)
{
...
String AdaptiveDecisionMaker::GetEvaluationType(const RealVector &cont_vars)
{
...
void AdaptiveDecisionMaker::RecordEvaluationError(const int         eval_id,
...
void AdaptiveDecisionMaker::RecordEvaluationDecision(
...
bool AdaptiveDecisionMaker::NeedToComputeErrors()
{
...
void AdaptiveDecisionMaker::LoadParameters(const IntRealVectorMap &from,
                                           MatrixXd               &into) const
{
...
void AdaptiveDecisionMaker::LoadResponses(const IntRealMap &from,
                                          VectorXd         &into) const
{
...
void AdaptiveDecisionMaker::CrossValidateGausssianModel() const
{
...
void AdaptiveDecisionMaker::Train()
{
                                                     ...
                                                     const String &suffix)
{
  ...
  for (int i = 0; i < num_points; ++i)
  {
    ...
    fprintf(model_data_file, "%16.8e  %16.8e  %16.8e\n", responses(i),
            p_responses(i), std::sqrt(variance(i)));
  }
