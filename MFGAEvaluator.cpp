 ...
 *   - Features re-evaluation of best designs with "APPROX" analysis.
 *
 * Licensing:
...
MFGAEvaluator::MFGAEvaluator(GeneticAlgorithm &algorithm, Model &sim_model_,
                             Model                 &err_model_,
...
MFGAEvaluator::MFGAEvaluator(const MFGAEvaluator &copy)
...
MFGAEvaluator::MFGAEvaluator(const MFGAEvaluator &copy, GeneticAlgorithm &algo,
...
void MFGAEvaluator::SetupLabelIndex()
{
  EDDY_FUNC_DEBUGSCOPE
...
bool MFGAEvaluator::Evaluate(Design &des)
{
  EDDY_FUNC_DEBUGSCOPE
  JEGALOG_II_F(
    GetLogger(), this,
...
string MFGAEvaluator::GetName() const
{
  EDDY_FUNC_DEBUGSCOPE
  return MFGAEvaluator::Name();
}

//-----------------------------------------------------------------------------

string MFGAEvaluator::GetDescription() const
{
  EDDY_FUNC_DEBUGSCOPE
  return MFGAEvaluator::Description();
}

//-----------------------------------------------------------------------------

GeneticAlgorithmOperator *
MFGAEvaluator::Clone(GeneticAlgorithm &algorithm) const
{
  EDDY_FUNC_DEBUGSCOPE
  return new MFGAEvaluator(*this, algorithm, sim_model, error_model,
                           decision_maker);
}

//-----------------------------------------------------------------------------

size_t MFGAEvaluator::GetNumberNonLinearConstraints() const
{
  EDDY_FUNC_DEBUGSCOPE
...
size_t MFGAEvaluator::GetNumberLinearConstraints() const
{
  EDDY_FUNC_DEBUGSCOPE
...
void MFGAEvaluator::SeparateVariables(const Design &from,
...
String MFGAEvaluator::GetEvaluationType(const RealVector &cont_vars)
{
  EDDY_FUNC_DEBUGSCOPE
...
void MFGAEvaluator::SetStateVariables(const RealVector &cont_vars,
...
void MFGAEvaluator::RecordResponses(const RealVector &from, Design &into) const
{
...
void MFGAEvaluator::RecordEvaluationInDecisionMaker(
...
void MFGAEvaluator::RecordErrorInDecisionMaker(
...
void MFGAEvaluator::ErrorEvaluationLoop()
{
...
bool MFGAEvaluator::EvaluationLoop(DesignGroup &group, String switch_val)
{
  EDDY_FUNC_DEBUGSCOPE
